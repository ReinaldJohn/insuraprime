const ContractorsPrimeGL = () => {
  return (
    <section>
      <div className="mx-auto max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
        <div className="mx-auto w-full max-w-3xl text-center">
          <h2 className="text-3xl font-semibold md:text-5xl">
            CONTRACTORS PRIME GL
          </h2>
          <div className="mx-auto mb-8 mt-4 max-w-[528px] md:mb-12 lg:mb-16">
            <p className="text-[#636262]">
              This A-rated, Non-Admitted CGL Program for Artisan and General
              Contractors uses ISO Policy Forms and Endorsements. Brokers can
              quickly rate, quote, bind, and issue policies through our online
              rater portal in minutes!
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8 md:grid-cols-3 lg:gap-12">
          <div className="relative mb-8 flex flex-col rounded-2xl border border-solid border-black p-8 [box-shadow:rgb(0,_0,_0)_9px_9px] lg:mb-4">
            ...
            <p className="mb-4 text-xl font-semibold">OnlineRater</p>
            <p>
              Online Rater allows brokers to rate quote, bind and issue in
              minutes!
            </p>
          </div>
          ...
          <div className="relative mb-8 flex flex-col rounded-2xl border border-solid border-black p-8 [box-shadow:rgb(0,_0,_0)_9px_9px] lg:mb-4">
            ...
            <p className="mb-4 text-xl font-semibold">AMBest</p>
            <p>AM Best Rated A-X, Non-Admitted Program.</p>
          </div>
          ...
          <div className="relative mb-8 flex flex-col rounded-2xl border border-solid border-black p-8 [box-shadow:rgb(0,_0,_0)_9px_9px] lg:mb-4">
            ...
            <p className="mb-4 text-xl font-semibold">Liability</p>
            <p>Limits of Liability up to $1M/$2M/$2M.</p>
          </div>
          ...
          <div className="relative mb-8 flex flex-col rounded-2xl border border-solid border-black p-8 [box-shadow:rgb(0,_0,_0)_9px_9px] lg:mb-4">
            ...
            <p className="mb-4 text-xl font-semibold">Defense</p>
            <p>Defense outside limits (Included).</p>
          </div>
          ...
          <div className="relative mb-8 flex flex-col rounded-2xl border border-solid border-black p-8 [box-shadow:rgb(0,_0,_0)_9px_9px] lg:mb-4">
            ...
            <p className="mb-4 text-xl font-semibold">Availability</p>
            <p>Available in all states except NY, HI and AK.</p>
          </div>
          ...
          <div className="relative mb-8 flex flex-col rounded-2xl border border-solid border-black p-8 [box-shadow:rgb(0,_0,_0)_9px_9px] lg:mb-4">
            ...
            <p className="mb-4 text-xl font-semibold">Rating</p>
            <p>Rating Basis Gross Receipts (Accounts up to $1.5M).</p>
          </div>
          ...
          <div className="relative mb-8 flex flex-col rounded-2xl border border-solid border-black p-8 [box-shadow:rgb(0,_0,_0)_9px_9px] lg:mb-4">
            ...
            <p className="mb-4 text-xl font-semibold">ISOForms</p>
            <ul>
              <li>Ongoing Operations (CG2010).</li>
              <li>Ongoing Operation NOC (CG2026).</li>
              <li>Completed Operations (CG2037).</li>
              <li>Waiver of Subrogation (CG2404).</li>
              <li>Primary and Noncontributory – Blanket (CG2001).</li>
              <li>Other Endorsements Available.</li>
            </ul>
          </div>
        </div>
      </div>
...
export default ContractorsPrimeGL;
